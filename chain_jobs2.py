...
CHECK_INTERVAL_HOURS = 1 #6 for first run, 1-2 for second run, 0.5 for later?
...
field = "COSMOS"
ver = "n3.0_v1.0"
cathead = "fitid2" #name of catalog for the first attempt, fitid or refitid 
cathead_ori = "fitid2" #name of reference catalog to check fitting is completed

spsver = 'spsbeta' #not set as a variable, need to edit submit_loop.py
outdir = '/scratch/alpine/ikmi3774/slurm/COSMOS2/'
